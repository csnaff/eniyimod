...
if(![(client.config.banhammer) , (client.config.owner) , (client.config.yetkilirol) , (client.config.jailhammer) ].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
