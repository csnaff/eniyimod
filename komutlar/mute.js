...
let KaraListe = data.fetch(`karaL.${message.author.id}`)
...
data.add(`muteAlma.${member.id}`, 1) //User kaç mute yemiş onu sayar
data.add(`muteAtma.${message.member.id}`, 1) //Yetkili kaçtane mute atmış onu sayar
