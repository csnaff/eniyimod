...
exports.run = async (client, message, args) => {
 ...
 if (!kullanıcı) return message.channel.send(new Discord.MessageEmbed().addField(`Arawn` `Bir kullanıcı etiketlemelisin!`).setColor("2e0101").setFooter(message.author.tag ,message.author.avatarURL).setTimestamp());
